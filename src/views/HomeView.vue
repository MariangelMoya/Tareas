  ...
  <div class="content flex items-center gap-x-8">
    ...
    <div class="w-1/2 flex justify-center">
      ...
      <form class=" bg-gray-600/70 py-5 px-8  rounded">
        ...
        <div class="mt-4">
          <input class="inputs-register" type="text" placeholder="Your Email">
        </div>

        <div class="mt-4">
          <input class="inputs-register" type="password" placeholder="Your Password">
        </div>

        <div class="mt-4">
          <input class="inputs-register" type="password" placeholder="Confirm Your Password">
        </div>

        <div class="mt-8 flex justify-normal">
          <input class="py-2 px-4 w-40 bg-cyan-400 text-white font-bold rounded hover:bg-cyan-500 hover:cursor-pointer"
                 type="submit" value="Get Stared Free">
        </div>
